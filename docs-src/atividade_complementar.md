...
![referencia](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/img/ilovelinux.png){width=300}
...
![Kernel logo](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/img/Kernel_basic.png){width=350}
...
![ssd](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/img/terminal.png){width=600}
...
![logo_ubuntu_software](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/img/logo_ubuntu_software.png){width=100}
...
![show_aplication](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/show_aplication.png){width=700}


![show_aplication](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/img/ubuntu_software.png){width=700}
...
![pasta logo](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/img/FilesAndFolders.png){width=350}
...
![nano logo](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/img/main-nano-window.png){width=600}
...
![nano logo](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/img/gedit3-screenshot.png){width=600}
...
![vscode logo](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/img/vscode-ui-in-container.png){width=600}
...
![roda_roda](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/img/roda_roda.gif)
