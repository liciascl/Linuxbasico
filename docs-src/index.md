...
| [Introdução ao Linux](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/atividade_complementar.md) | Parte teórica da Atividade complementar - introdução ao Linux |
|  [DESAFIO - Introdução ao Linux](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/desafio.md) | Após aprender os comandos básicos, temos um desafio pra você |
| [Colinha com os principais comandos](https://github.com/liciascl/Linuxbasico/blob/master/docs-src/colinha.md) | Seleção com os comandos mais utilizados para facilitar a sua vida|
